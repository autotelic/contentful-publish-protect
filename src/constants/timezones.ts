export const timezones = [
  ...
  { label: '(UTC+00:00) - Africa/Sao Tome', value: 'Africa/Sao Tome' },
  ...
  { label: '(UTC+00:00) - Atlantic/St Helena', value: 'Atlantic/St Helena' },
  ...
  { label: '(UTC+01:00) - Africa/El Aaiun', value: 'Africa/El Aaiun' },
  ...
  { label: '(UTC+01:00) - Europe/Isle of Man', value: 'Europe/Isle of Man' },
  ...
  { label: '(UTC+02:00) - Atlantic/Jan Mayen', value: 'Atlantic/Jan Mayen' },
  ...
  { label: '(UTC+02:00) - Europe/San Marino', value: 'Europe/San Marino' },
  ...
  { label: '(UTC+03:00) - Africa/Addis Ababa', value: 'Africa/Addis Ababa' },
  ...
  { label: '(UTC+03:00) - Africa/Dar es Salaam', value: 'Africa/Dar es Salaam' },
  ...
  { label: '(UTC+03:00) - Asia/Tel Aviv', value: 'Asia/Tel Aviv' },
  ...
  { label: '(UTC+07:00) - Asia/Ho Chi Minh', value: 'Asia/Ho Chi Minh' },
  ...
  { label: '(UTC+07:00) - Asia/Phnom Penh', value: 'Asia/Phnom Penh' },
  ...
  { label: '(UTC+08:00) - Asia/Hong Kong', value: 'Asia/Hong Kong' },
  { label: '(UTC+08:00) - Asia/Irkutsk', value: 'Asia/Irkutsk' },
  { label: '(UTC+08:00) - Asia/Kuala Lumpur', value: 'Asia/Kuala Lumpur' },
  ...
  { label: '(UTC+08:00) - Asia/Ujung Pandang', value: 'Asia/Ujung Pandang' },
  { label: '(UTC+08:00) - Asia/Ulaanbaatar', value: 'Asia/Ulaanbaatar' },
  { label: '(UTC+08:00) - Asia/Ulan Bator', value: 'Asia/Ulan Bator' },
  ...
  { label: '(UTC+09:30) - Australia/Broken Hill', value: 'Australia/Broken Hill' },
  ...
  { label: '(UTC+10:00) - Pacific/Port Moresby', value: 'Pacific/Port Moresby' },
  ...
  { label: '(UTC+10:30) - Australia/Lord Howe', value: 'Australia/Lord Howe' },
  ...
  { label: '(UTC+12:00) - Antarctica/South Pole', value: 'Antarctica/South Pole' },
  ...
  { label: '(UTC-01:00) - Atlantic/Cape Verde', value: 'Atlantic/Cape Verde' },
  { label: '(UTC-01:00) - Etc/GMT+1', value: 'Etc/GMT+1' },
  ...
  { label: '(UTC-02:00) - Atlantic/South Georgia', value: 'Atlantic/South Georgia' },
  { label: '(UTC-02:00) - Brazil/DeNoronha', value: 'Brazil/DeNoronha' },
  { label: '(UTC-02:00) - Etc/GMT+2', value: 'Etc/GMT+2' },
  { label: '(UTC-02:30) - America/St Johns', value: 'America/St Johns' },
  { label: '(UTC-02:30) - Canada/Newfoundland', value: 'Canada/Newfoundland' },
  { label: '(UTC-03:00) - America/Araguaina', value: 'America/Araguaina' },
  { label: '(UTC-03:00) - America/Argentina/Buenos Aires', value: 'America/Argentina/Buenos Aires' },
  { label: '(UTC-03:00) - America/Argentina/Catamarca', value: 'America/Argentina/Catamarca' },
  { label: '(UTC-03:00) - America/Argentina/ComodRivadavia', value: 'America/Argentina/ComodRivadavia' },
  ...
  { label: '(UTC-03:00) - America/Argentina/La Rioja', value: 'America/Argentina/La Rioja' },
  { label: '(UTC-03:00) - America/Argentina/Mendoza', value: 'America/Argentina/Mendoza' },
  { label: '(UTC-03:00) - America/Argentina/Rio Gallegos', value: 'America/Argentina/Rio Gallegos' },
  { label: '(UTC-03:00) - America/Argentina/Salta', value: 'America/Argentina/Salta' },
  { label: '(UTC-03:00) - America/Argentina/San Juan', value: 'America/Argentina/San Juan' },
  { label: '(UTC-03:00) - America/Argentina/San Luis', value: 'America/Argentina/San Luis' },
  ...
  { label: '(UTC-03:00) - America/Buenos Aires', value: 'America/Buenos Aires' },
  ...
  { label: '(UTC-03:00) - America/Glace Bay', value: 'America/Glace Bay' },
  { label: '(UTC-03:00) - America/Goose Bay', value: 'America/Goose Bay' },
  ...
  { label: '(UTC-03:00) - America/Punta Arenas', value: 'America/Punta Arenas' },
  ...
  { label: '(UTC-03:00) - America/Sao Paulo', value: 'America/Sao Paulo' },
  ...
  { label: '(UTC-04:00) - America/Boa Vista', value: 'America/Boa Vista' },
  { label: '(UTC-04:00) - America/Campo Grande', value: 'America/Campo Grande' },
  ...
  { label: '(UTC-04:00) - America/Fort Wayne', value: 'America/Fort Wayne' },
  { label: '(UTC-04:00) - America/Grand Turk', value: 'America/Grand Turk' },
  ...
  { label: '(UTC-04:00) - America/La Paz', value: 'America/La Paz' },
  { label: '(UTC-04:00) - America/Louisville', value: 'America/Louisville' },
  { label: '(UTC-04:00) - America/Lower Princes', value: 'America/Lower Princes' },
  ...
  { label: '(UTC-04:00) - America/New York', value: 'America/New York' },
  ...
  { label: '(UTC-04:00) - America/Port of Spain', value: 'America/Port of Spain' },
  { label: '(UTC-04:00) - America/Porto Velho', value: 'America/Porto Velho' },
  { label: '(UTC-04:00) - America/Puerto Rico', value: 'America/Puerto Rico' },
  { label: '(UTC-04:00) - America/Santiago', value: 'America/Santiago' },
  { label: '(UTC-04:00) - America/Santo Domingo', value: 'America/Santo Domingo' },
  { label: '(UTC-04:00) - America/St Barthelemy', value: 'America/St Barthelemy' },
  { label: '(UTC-04:00) - America/St Kitts', value: 'America/St Kitts' },
  { label: '(UTC-04:00) - America/St Lucia', value: 'America/St Lucia' },
  { label: '(UTC-04:00) - America/St Thomas', value: 'America/St Thomas' },
  { label: '(UTC-04:00) - America/St Vincent', value: 'America/St Vincent' },
  { label: '(UTC-04:00) - America/Thunder Bay', value: 'America/Thunder Bay' },
  ...
  { label: '(UTC-05:00) - America/Coral Harbour', value: 'America/Coral Harbour' },
  ...
  { label: '(UTC-05:00) - America/Indiana/Tell City', value: 'America/Indiana/Tell City' },
  { label: '(UTC-05:00) - America/Jamaica', value: 'America/Jamaica' },
  { label: '(UTC-05:00) - America/Knox IN', value: 'America/Knox IN' },
  ...
  { label: '(UTC-05:00) - America/North Dakota/Beulah', value: 'America/North Dakota/Beulah' },
  { label: '(UTC-05:00) - America/North Dakota/Center', value: 'America/North Dakota/Center' },
  { label: '(UTC-05:00) - America/North Dakota/New Salem', value: 'America/North Dakota/New Salem' },
  { label: '(UTC-05:00) - America/Ojinaga', value: 'America/Ojinaga' },
  { label: '(UTC-05:00) - America/Panama', value: 'America/Panama' },
  { label: '(UTC-05:00) - America/Porto Acre', value: 'America/Porto Acre' },
  { label: '(UTC-05:00) - America/Rainy River', value: 'America/Rainy River' },
  { label: '(UTC-05:00) - America/Rankin Inlet', value: 'America/Rankin Inlet' },
  { label: '(UTC-05:00) - America/Resolute', value: 'America/Resolute' },
  { label: '(UTC-05:00) - America/Rio Branco', value: 'America/Rio Branco' },
  ...
  { label: '(UTC-06:00) - America/Bahia Banderas', value: 'America/Bahia Banderas' },
  { label: '(UTC-06:00) - America/Belize', value: 'America/Belize' },
  { label: '(UTC-06:00) - America/Boise', value: 'America/Boise' },
  { label: '(UTC-06:00) - America/Cambridge Bay', value: 'America/Cambridge Bay' },
  { label: '(UTC-06:00) - America/Chihuahua', value: 'America/Chihuahua' },
  { label: '(UTC-06:00) - America/Ciudad Juarez', value: 'America/Ciudad Juarez' },
  { label: '(UTC-06:00) - America/Costa Rica', value: 'America/Costa Rica' },
  { label: '(UTC-06:00) - America/Denver', value: 'America/Denver' },
  { label: '(UTC-06:00) - America/Edmonton', value: 'America/Edmonton' },
  { label: '(UTC-06:00) - America/El Salvador', value: 'America/El Salvador' },
  ...
  { label: '(UTC-06:00) - America/Mexico City', value: 'America/Mexico City' },
  ...
  { label: '(UTC-06:00) - America/Swift Current', value: 'America/Swift Current' },
  ...
  { label: '(UTC-07:00) - America/Dawson Creek', value: 'America/Dawson Creek' },
  { label: '(UTC-07:00) - America/Ensenada', value: 'America/Ensenada' },
  { label: '(UTC-07:00) - America/Fort Nelson', value: 'America/Fort Nelson' },
  { label: '(UTC-07:00) - America/Hermosillo', value: 'America/Hermosillo' },
  { label: '(UTC-07:00) - America/Los Angeles', value: 'America/Los Angeles' },
  { label: '(UTC-07:00) - America/Mazatlan', value: 'America/Mazatlan' },
  { label: '(UTC-07:00) - America/Phoenix', value: 'America/Phoenix' },
  { label: '(UTC-07:00) - America/Santa Isabel', value: 'America/Santa Isabel' },
  ...
  { label: '(UTC-11:00) - Pacific/Pago Pago', value: 'Pacific/Pago Pago' },
